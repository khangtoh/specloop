...
| 3 | [03-preflight-check.md](03-preflight-check.md) | `specloop preflight` workspace checks; bare `specloop` runs them (breaking, 0.4.0) | 🟡 5/26 | Phase 02 (run-state record) |
